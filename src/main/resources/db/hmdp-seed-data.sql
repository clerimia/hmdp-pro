...
--    - 券 11：未开始（用于测试未开抢拦截）
--    - 券 12：已结束（用于测试关单/对账/历史订单查询）
-- 2. 账本自洽（对账任务不误报）：
--    tb_seckill_voucher.stock = initial_stock - 有效订单数（状态非"已取消"）
...
-- ----------------------------
-- 8. 订单（主键为 UidGenerator 雪花值）
--    券 10 秒杀洪峰 3 单（未支付/已支付/已核销各 1）
--    券 12 历史洪峰 4 单；券 1 普通券 2 单
--    状态：1 未支付；2 已支付；3 已核销
-- ----------------------------
...
--    同一秒内的多单 seq 递增（模拟秒杀洪峰并发取号）
INSERT INTO `tb_voucher_order` (`id`, `user_id`, `voucher_id`, `pay_type`, `status`, `create_time`, `pay_time`, `use_time`, `refund_time`) VALUES
-- 券 10（进行中秒杀）洪峰：worker=1，同一秒 seq 0/1/2
(725595245319823360, 1, 10, 3, 3, '2026-09-02 10:00:01', '2026-09-02 10:01:12', '2026-09-02 12:30:00', NULL),
(725595245319823361, 2, 10, 2, 2, '2026-09-02 10:00:01', '2026-09-02 10:02:40', NULL, NULL),
(725595245319823362, 3, 10, 1, 1, '2026-09-02 10:00:01', NULL, NULL, NULL),
-- 券 12（已结束秒杀）洪峰：worker=2，同一秒 seq 0/1/2/3
(705989578607050752, 1, 12, 2, 3, '2026-08-26 19:30:01', '2026-08-26 19:31:00', '2026-08-28 18:00:00', NULL),
(705989578607050753, 2, 12, 3, 3, '2026-08-26 19:30:01', '2026-08-26 19:32:10', '2026-08-29 12:20:00', NULL),
(705989578607050754, 3, 12, 1, 2, '2026-08-26 19:30:01', '2026-08-26 19:33:45', NULL, NULL),
(705989578607050755, 4, 12, 3, 2, '2026-08-26 19:30:01', '2026-08-26 19:35:20', NULL, NULL),
-- 券 1（普通券，非秒杀）：worker=1/3，各自独占一秒 seq=0
(624907433646497792, 1, 1, 2, 3, '2026-07-30 12:00:00', '2026-07-30 12:00:30', '2026-08-02 18:30:00', NULL),
(643585387423358976, 2, 1, 3, 2, '2026-08-05 19:00:00', '2026-08-05 19:00:40', NULL, NULL);
